...
public class GroupTest {
	...
	@Test(priority=4,groups="dropDown")
	...
	@Test(priority=5,groups="dropDown")
	...
	@Test(priority=6,groups="dropDown")
	...
	@Test(priority=7,groups="datePicker")
	...
	@Test(priority=8,groups="datePicker")
	...
	@Test(priority=9,groups="windowHandling")
	...
	@Test(priority=10,groups="windowHandling")
	...
	@Test(priority=11,groups="fileUploading")
	...
	@Test(priority=12,groups="fileUploading")
	...
	@Test(priority=13,groups="webTable")
	...
	@Test(priority=14,groups="webTable")
	...
	@Test(priority=19,groups="downloadFileArea")
	...
	@Test(priority=20,groups="windowHandlings")
	...
	@Test(priority=21,groups="windowHandlings")
	...
	@Test(priority=22,groups="windowHandlings")
	...
	@Test(priority=26,groups="mouseBasedActions")
	...
	@Test(priority=27,groups="mouseBasedActions")
	...
	@Test(priority=28,groups="mouseBasedActions")
	...
	@Test(priority=29,groups="mouseBasedActions")
...
//		as.dragAndDropBy(slider2, 30, 0).build().perform();
	...
	@Test(priority=32,groups="scrollingDropDown")
	...
	@Test(priority=33,groups="brokenLinks")
	...
	@Test(priority=34,groups="shadowDomSendKeys")
